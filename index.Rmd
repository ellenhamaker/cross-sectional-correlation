...
The first curiosity is concerned with the difference between the within-person correlation and the average person-specific correlation, that is,
...
The second curiosity has to do with the weights (which are based on the intraclass correlations). Unless the intraclass correlations are the same for $X$ ad $Y$, the two weights do not add up to one. Specifically,
