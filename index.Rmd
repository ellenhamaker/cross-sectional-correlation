---
title: "The Curious Case of the Cross-Sectional Correlation -- Supplemantary Materials"
...
In the paper, I derive the following expression for the cross-sectional correlation
...
* $\eta^2_{BX}$ is the intraclass correlation of $X$ (proportion of stable differences between persons on X)

* $\eta^2_{BY}$ is the intraclass correlation of $Y$ (proportion of stable differences between persons on X)
...
This expression is well known in certain parts of the scientific literature. However, despite the simple appearance of this expression, in the paper I show two curiosities associated with it:

* The within-person correlation $\rho_W$ is *not* the same as the average person-specific correlation; it is only the same under specific circumstances (such as ergodicity)

* The weights (which are based on the intracless correlations) do not always add up to one, and as a result, the cross-sectional correlation $\rho$ may lie closer to 0 than both the between-person correlation $\rho_B$ and the within-person correlation $\rho_W$.


# Summary of approach

Here I will show how to derive the value of the average person-specific correlation $\kappa$, the within-person correlation $\rho_W$, and the cross-sectional correlation $\rho$, using the analytical results presented in the paper. 
