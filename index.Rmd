...
| Example| Value |
|:-----------|:----------------------------|
1 | $\rho_W < \rho <\rho_B = \kappa$
2 | $\rho < \rho_W <\rho_B = \kappa$
3 | $\rho < \rho_W =\rho_B = \kappa$
4 | $\rho < \rho_W <\rho_B = \kappa = \kappa_p$
5 | $\rho = \rho_W < \kappa$ and $\rho_B$ does not exist
6 | $\rho_B < \rho < \rho_W < \kappa$
7 | $\rho = \rho_W = \rho_B < \kappa$
